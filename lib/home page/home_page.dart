            ...
            Container(
              ...
              width: double.infinity,
                 child: Row(
                  ...
                  children: [
                    ElevatedButton (onPressed:  (){}, child: Icon(Icons.shop_rounded ,size:50, ),),
                    IconButton(onPressed:  (){}, icon:  Icon(Icons.shop_rounded ,size:50,semanticLabel: 'Shop Now',),),
                    IconButton(onPressed:  (){}, icon:  Icon(Icons.movie_creation_outlined,size: 50,))
                            ...
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                  child: GestureDetector(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder:  (context)=>ProductDetailsScreen(productName: product.products?[index].title, id:  product.products?[index].id, image:  product.products?[index].image,price:  product.products?[index].price,description: product.products?[index].description,)));
                                    },
                // onTap: (){
